...
#define D 11 // Data dimensionality
#define ITE 100 // number of iterations
#define STEPS 9 // increase in the points 
...
int main( int argc, char* argv[] )
{
    ...
    string centroids_file = "../datasets/winecentroids.txt";
    string points_file = "../datasets/winepoints.txt";
    string output_file = "../testbench_out/winehamerly" + to_string(threads) + "T.txt";
