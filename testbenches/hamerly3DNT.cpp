...
int main( int argc, char* argv[] )
{
    ...
    string centroids_file = "../datasets/centroids3D.txt";
    string points_file = "../datasets/points3D.txt";
    string output_file = "../testbench_out/hamerly3D" + to_string(threads) + "T.txt";
